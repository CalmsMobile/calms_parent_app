                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      decoration: BoxDecoration(
                        border: Border(
                          bottom: BorderSide(color: Colors.black38, width: .3),
                        ),
                      ),
                      height: 35,
                      padding:
                          EdgeInsets.only(left: 10.0, top: 0.0, bottom: 20.0),
                    ...
                    Container(
                      height: 25,
                      padding: EdgeInsets.only(
                          left: 10.0, right: 0, top: 10.0, bottom: 0.0),
                      margin: EdgeInsets.symmetric(vertical: 0),
                      width: double.infinity,
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () =>
                                      openLimitTypeBottomSheet(context),
                                ),
                              )
                            ],
                          ),
